...
export class FindNotesUseCaseImpl implements FindNotesUseCase {
  ...
  public async execute(input: FindNotesUseCase.Input): Promise<FindNotesUseCase.Output> {
    ...
    switch (response.statusCode) {
      case HttpStatusCode.ok: return response.body as FindNotesUseCase.Output
